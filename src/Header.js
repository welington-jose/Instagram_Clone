    ...
    function Header(props) {
      ...
      function criarConta(e) {
        ...
        e.preventDefault();
        let perfil = document.getElementById('foto-perfil').value;
      ...
      function validarFoto(e){
        ...
        if (!file.type.match(/^image\/(png|jpeg)$/)) {
          alert("O arquivo selecionado não é uma foto.");
          e.preventDefault();
        }
        ...
        <div className="header">
          ...
          <div className="modalCriarConta">
            <div className="formCriarConta">
              ...
              <input type="file" placeholder="Selecione uma foto" accept="image/png, image/jpeg"/>
